...
const pageTitle = computed(() => {
  const titleMap = {
    ...
    'tools-base64-encoder': 'Base64编码',
    'tools-url-encoder': 'URL编码',
    'tools-text-processor': '文本处理器',
    'tools-image-compressor': '图片压缩',
    'tools-image-converter': '格式转换',
    'tools-image-resizer': '尺寸调整',
    'tools-operations': '运维工具',
    'tools-academic': '学术工具',
    'tools-query': '查询工具',
    'tools-document': '文档工具',
    'tools-others': '其它工具',
